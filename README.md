...
> **v0.1.0.** `passalong-server serve` answers every operation of the [API](docs/api/README.md) over TLS
...
> speaks to it from its v0.3.0. Start with the idea report,
